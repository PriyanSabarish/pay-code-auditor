...
export default function QuestionCard({question,auditId}:{question:ClarifyingQuestion;auditId:string}) {
  ...
  return <section className="question-card" aria-labelledby="question-title"><div className="question-icon"><MessageSquareText size={23}/></div><div className="question-body">
    <div className="eyebrow">YOUR CONTEXT MATTERS / {question.code}</div><h3 id="question-title">{question.question}</h3>{question.context&&<p>{question.context}</p>}
